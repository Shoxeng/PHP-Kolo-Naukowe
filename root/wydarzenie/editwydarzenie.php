...
<html>
	...
	<body>
		...
		?>
		<div class="login">
			<h1>Edytuj wydarzenie wydarzenie</h1>
			<form action="_editwydarzenie.php" method="post" enctype="multipart/form-data">
				...
				$stmt->close();
				?>
				<input type="hidden" name="keyword" id="keyword" value=<?echo $_GET['keyword']?> required>
